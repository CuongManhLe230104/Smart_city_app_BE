        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RouteNumber = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    ...
                    StartPoint = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    EndPoint = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Price = table.Column<decimal>(type: "decimal(10,2)", nullable: true),
                    FirstBusTime = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    LastBusTime = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    TripDuration = table.Column<int>(type: "int", nullable: true),
                    StopsJson = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventBanners", x => x.Id);
                });
